      ...
      <section className='max-w-[1200px] mx-auto text-white '>
        <div className="grid md:grid-cols-3 py-5 ">
            ...
            <div className='py-8 px-4 '>
                ...
                <p>Get Exclusive <span className='font-bold'>Updates</span>straight to your inbox.</p>
                <br />
                <div className='flex items-center h-10 '>
                    <input type="text" className='py-1 px-3 w-full h-[100%] inline-block focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500 bg-gray-800 border-gray-200 border-2'
                    placeholder='Email' />
